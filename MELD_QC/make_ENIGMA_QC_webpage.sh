...
echo "</tr>"                                                                                >> ENIGMA_Cortical_QC.html
echo "<tr>"                                                                                 >> ENIGMA_Cortical_QC.html
echo "<td><a href=\"file:"$sub"/Cortical_set_Axial_20.png\" href=\"file:"$sub"/Cortical_set_Axial_20.png\" ><img src=\""$sub"/Cortical_set_Axial_70_20.png\" width=\"100%\" ></a></td>"	>> ENIGMA_Cortical_QC.html
